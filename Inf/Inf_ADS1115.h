...
/* ADS1115Ö¸Õë¼Ä´æÆ÷  ÏòµÍ2Î»Ð´Èë²»Í¬µÄÖµ±íÊ¾²Ù×÷²»Í¬µÄÆäËû¼Ä´æÆ÷ */
#define ADS1115_REG_POINTER_MASK (0x03)      /* Ö¸Õë¼Ä´æÆ÷ÑÚÂë */
#define ADS1115_REG_POINTER_CONVERT (0x00)   /* ¶ÁÈ¡×ª»»¼Ä´æÆ÷£¨ADC×ª»»ºóµÄÖµ£© */
#define ADS1115_REG_POINTER_CONFIG (0x01)    /* ¶ÁÐ´ÅäÖÃ¼Ä´æÆ÷  */
#define ADS1115_REG_POINTER_LOWTHRESH (0x02) /* Lo_thresh ¼Ä´æÆ÷ */
#define ADS1115_REG_POINTER_HITHRESH (0x03)  /* Hi_thresh  ¼Ä´æÆ÷ */
